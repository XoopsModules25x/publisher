...
<{if $items|default:false}>
    ...
    <table border="0" width="90%" cellspacing="1" cellpadding="3" align="center" class="outer">
        <tr>
            ...
            <{/if}> <{if $display_hits_col|default:0 == 1}>
        ...
        <{foreach item=item from=$items}>
            <tr>
                <td class="even" align="left">
                    ...
                    <small>
                       <{if $display_category|default:0 == 1}> <{$item.category}> | <{/if}> 
                       <{if $display_commentlink|default:0 == 1 && $item.cancomment|default:false && $item.comments|default:0 != -1}><{$item.comments}><{/if}></small>
