    ...
    <div style="width:100%;">
        <{section name=i loop=$block.columns}>
            <div style="width: <{$block.columnwidth}>%;" class="publisher-left">
                ...
                <{if $block.display_datemainitem == '1'}><span style="font-size: 11px; padding: 0 0 0 16px; margin: 0; line-height: 12px; opacity:0.8;-moz-opacity:0.8;">
                     <span class="glyphicon glyphicon-date"></span>&nbsp;<{$item.date}></span>
                <{/if}>
        ...
        <div style="width: <{$block.columnwidth}>%;" class="publisher-left">
            <{foreach item=item from=$block.columns[i]}>
                <div class="publisher-box publisher-clearfix">
                    ...
                    <span class="glyphicon glyphicon-date"></span>&nbsp;<{$item.date}>
                </span><{/if}>
