    ...
    <div class="container">
        <{foreach item=story from=$stories}>
                ...
                <span style="font-size: 11px; padding: 0; margin: 0; line-height: 12px; opacity:0.8;-moz-opacity:0.8;">
                    <span class="fa fa-tag"></span>&nbsp;<{$story.category}>
                </span>
                 <{/if}>
                 <{if $showposter == 1}>
                <span style="font-size: 11px; padding: 0 0 0 16px; margin: 0; line-height: 12px; opacity:0.8;-moz-opacity:0.8;">
                    <span class="fa fa-user"></span>&nbsp;<{$story.author}>
                </span>
                 <{/if}>
                <{if $showdate == 1}>
                 <span style="font-size: 11px; padding: 0 0 0 16px; margin: 0; line-height: 12px; opacity:0.8;-moz-opacity:0.8;">
                    <span class="fa fa-calendar"></span>&nbsp;<{$story.date}>
                </span>
                 <{/if}>
                 <{if $showhits == 1}>
                 <span style="font-size: 11px; padding: 0 0 0 16px; margin: 0; line-height: 12px; opacity:0.8;-moz-opacity:0.8;">
                    <span class="fa fa-check-circle-o"></span>&nbsp;<{$story.counter}> <{$smarty.const._MD_PUBLISHER_READS}>
                </span>
                 <{/if}>
                 <{if $showcomment == 1 && $story.cancomment && $story.comment != -1}>
                 <span style="font-size: 11px; padding: 0 0 0 16px; margin: 0; line-height: 12px; opacity:0.8;-moz-opacity:0.8;">
                    <span class="fa fa-comment"></span>&nbsp;<{$story.comment}> 
                </span>
                 <{/if}>
                </div>
