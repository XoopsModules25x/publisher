        ...
        <div class="blog_ratingblock">
            <div id="unit_long<{$item.id}>">
                <div id="unit_ul<{$item.id}>" class="blog_unit-rating">
                    ...
                    <div>
                        <a class="blog_r1-unit rater" href="ratelike.php?op=save&amp;<{$itemid}>=<{$item.id}>&rating=1&amp;source=1" title="<{$smarty.const._MA_BLOG_RATING1}>" rel="nofollow">1</a>
                    </div>
                    <div>
                        <a class="blog_r2-unit rater" href="ratelike.php?op=save&amp;<{$itemid}>=<{$item.id}>&rating=2&amp;source=1" title="<{$smarty.const._MA_BLOG_RATING2}>" rel="nofollow">2</a>
                    </div>
                    <div>
                        <a class="blog_r3-unit rater" href="ratelike.php?op=save&amp;<{$itemid}>=<{$item.id}>&rating=3&amp;source=1" title="<{$smarty.const._MA_BLOG_RATING3}>" rel="nofollow">3</a>
                    </div>
                    <div>
                        <a class="blog_r4-unit rater" href="ratelike.php?op=save&amp;<{$itemid}>=<{$item.id}>&rating=4&amp;source=1" title="<{$smarty.const._MA_BLOG_RATING4}>" rel="nofollow">4</a>
                    </div>
                    <div>
                        <a class="blog_r5-unit rater" href="ratelike.php?op=save&amp;<{$itemid}>=<{$item.id}>&rating=5&amp;source=1" title="<{$smarty.const._MA_BLOG_RATING5}>" rel="nofollow">5</a>
                    </div>
                </div>
                <div>
                    <{$item.rating.text}>
        ...
        <div class="blog_ratingblock">
            <div id="unit_long<{$item.id}>">
                <div id="unit_ul<{$item.id}>" class="blog_unit-rating-10">
                    <div class="blog_current-rating" style="width:<{$item.rating.size}>;"><{$item.rating.text}></div>
                    <div>
                        <a class="blog_r1-unit rater" href="ratelike.php?op=save&amp;<{$itemid}>=<{$item.id}>&rating=1&amp;source=1" title="<{$smarty.const._MA_BLOG_RATING_10_1}>" rel="nofollow">1</a>
                    </div>
                    <div>
                        <a class="blog_r2-unit rater" href="ratelike.php?op=save&amp;<{$itemid}>=<{$item.id}>&rating=2&amp;source=1" title="<{$smarty.const._MA_BLOG_RATING_10_2}>" rel="nofollow">2</a>
                    </div>
                    <div>
                        <a class="blog_r3-unit rater" href="ratelike.php?op=save&amp;<{$itemid}>=<{$item.id}>&rating=3&amp;source=1" title="<{$smarty.const._MA_BLOG_RATING_10_3}>" rel="nofollow">3</a>
                    </div>
                    <div>
                        <a class="blog_r4-unit rater" href="ratelike.php?op=save&amp;<{$itemid}>=<{$item.id}>&rating=4&amp;source=1" title="<{$smarty.const._MA_BLOG_RATING_10_4}>" rel="nofollow">4</a>
                    </div>
                    <div>
                        <a class="blog_r5-unit rater" href="ratelike.php?op=save&amp;<{$itemid}>=<{$item.id}>&rating=5&amp;source=1" title="<{$smarty.const._MA_BLOG_RATING_10_5}>" rel="nofollow">5</a>
                    </div>
                    <div>
                        <a class="blog_r6-unit rater" href="ratelike.php?op=save&amp;<{$itemid}>=<{$item.id}>&rating=6&amp;source=1" title="<{$smarty.const._MA_BLOG_RATING_10_6}>" rel="nofollow">6</a>
                    </div>
                    <div>
                        <a class="blog_r7-unit rater" href="ratelike.php?op=save&amp;<{$itemid}>=<{$item.id}>&rating=7&amp;source=1" title="<{$smarty.const._MA_BLOG_RATING_10_7}>" rel="nofollow">7</a>
                    </div>
                    <div>
                        <a class="blog_r8-unit rater" href="ratelike.php?op=save&amp;<{$itemid}>=<{$item.id}>&rating=8&amp;source=1" title="<{$smarty.const._MA_BLOG_RATING_10_8}>" rel="nofollow">8</a>
                    </div>
                    <div>
                        <a class="blog_r9-unit rater" href="ratelike.php?op=save&amp;<{$itemid}>=<{$item.id}>&rating=9&amp;source=1" title="<{$smarty.const._MA_BLOG_RATING_10_9}>" rel="nofollow">9</a>
                    </div>
                    <div>
                        <a class="blog_r10-unit rater" href="ratelike.php?op=save&amp;<{$itemid}>=<{$item.id}>&rating=10&amp;source=1" title="<{$smarty.const._MA_BLOG_RATING_10_10}>" rel="nofollow">10</a>
                    </div>
                </div>
                <div>
                    <{$item.rating.text}>
...
<{*                <img class='blog-btn-icon' src='<{$blog_icon_url_16}>/like.png' alt='<{$smarty.const._MA_BLOG_RATING_LIKE}>' title='<{$smarty.const._MA_BLOG_RATING_LIKE}>'>(<{$item.rating.likes}>)</a>*}>
            ...
            <a class="blog-rate-dislike" href="ratelike.php?op=save&amp;<{$itemid}>=<{$item.id}>&rating=-1&amp;source=1" title="<{$smarty.const._MA_BLOG_RATING_DISLIKE}>" rel="nofollow">
...
<{*                <img class='blog-btn-icon' src='<{$blog_icon_url_16}>/dislike.png' alt='<{$smarty.const._MA_BLOG_RATING_DISLIKE}>' title='<{$smarty.const._MA_BLOG_RATING_DISLIKE}>'> (<{$item.rating.dislikes}>)</a>*}>
    ...
    <{if $rating_reaction}>
        <div class="blog_ratingblock">
                ...
                <a class="blog-rate-reaction" href="ratelike.php?op=save&amp;<{$itemid}>=<{$item.id}>&rating=2&amp;source=1" title="<{$smarty.const._MA_BLOG_RATING2}>" rel="nofollow">
                ...
                <a class="blog-rate-reaction" href="ratelike.php?op=save&amp;<{$itemid}>=<{$item.id}>&rating=3&amp;source=1" title="<{$smarty.const._MA_BLOG_RATING3}>" rel="nofollow">
                ...
                <a class="blog-rate-reaction" href="ratelike.php?op=save&amp;<{$itemid}>=<{$item.id}>&rating=4&amp;source=1" title="<{$smarty.const._MA_BLOG_RATING4}>" rel="nofollow">
                ...
                <a class="blog-rate-reactionr" href="ratelike.php?op=save&amp;<{$itemid}>=<{$item.id}>&rating=5&amp;source=1" title="<{$smarty.const._MA_BLOG_RATING5}>" rel="nofollow">
                ...
                <a class="blog-rate-reaction" href="ratelike.php?op=save&amp;<{$itemid}>=<{$item.id}>&rating=5&amp;source=1" title="<{$smarty.const._MA_BLOG_RATING5}>" rel="nofollow">
